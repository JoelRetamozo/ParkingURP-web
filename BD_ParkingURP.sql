...
CREATE TABLE IF NOT EXISTS `BD_ParkingURP`.`T_Control` (
  ...
  `codigo` CHAR(9) NOT NULL,
  `placa` CHAR(15) NOT NULL,
  PRIMARY KEY (`id_control`, `codigo`, `placa`),
  INDEX `fk_T_Control_T_Persona_has_T_Vehiculo1_idx` (`codigo` ASC, `placa` ASC),
  CONSTRAINT `fk_T_Control_T_Persona_has_T_Vehiculo1`
    FOREIGN KEY (`codigo` , `placa`)
    REFERENCES `BD_ParkingURP`.`T_Persona_has_T_Vehiculo` (`codigo` , `placa`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
START TRANSACTION;
USE `BD_ParkingURP`;
INSERT INTO `BD_ParkingURP`.`T_Usuario` (`codigo`, `password`, `estado`, `fecha_registro`, `perfil`) VALUES ('74840159', 'abel123', '1', DEFAULT, 'Vigilante');
INSERT INTO `BD_ParkingURP`.`T_Usuario` (`codigo`, `password`, `estado`, `fecha_registro`, `perfil`) VALUES ('77050095', 'joel123', '1', DEFAULT, 'Supervisor');
INSERT INTO `BD_ParkingURP`.`T_Usuario` (`codigo`, `password`, `estado`, `fecha_registro`, `perfil`) VALUES ('74125055', 'naty123', '1', DEFAULT, 'Administrador');
INSERT INTO `BD_ParkingURP`.`T_Usuario` (`codigo`, `password`, `estado`, `fecha_registro`, `perfil`) VALUES ('201411534', 'richi123', '1', DEFAULT, 'Conductor');
